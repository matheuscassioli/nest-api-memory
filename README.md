...
* **TypeORM** (ORMs/Mapeamento Objeto-Relacional)
...
* **JWT (JSON Web Token)** (Autenticação baseada em tokens estateless)
...
* **Services:** Centralizam as regras e a lógica de negócio (como checagem de e-mails duplicados e hashes de senhas).
